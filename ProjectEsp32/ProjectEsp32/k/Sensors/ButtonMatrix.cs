...
namespace Periphery.Sensors
{
    ...
    {
        internal ButtonMatrix(int[] pinNumbersIn, int[] pinNumbersOut) : base(pinNumbersOut, pinNumbersIn, Constants.Time.Debounce, PeripheryController.GpioController, false)
        {
            KeyEvent += (sender, e) =>
            {
